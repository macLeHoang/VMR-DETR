...
from vmr_detr.ops.span_utils import span_cxw_to_xx
from utils.basic_utils import l2_normalize_np_array
import torch.nn.functional as F
import numpy as np


class VMRDETRPredictor:
    def __init__(self, ckpt_path, clip_model_name_or_path="ViT-B/32", device="cuda"):
        ...
        print("Loading trained vmr-detr model...")
    ...
    def localize_moment(self, video_path, query_list):
        ...
        assert n_frames <= 75, "The positional embedding of this pretrained VMRDETR only support video up " \
...
def run_example():
    ...
    ckpt_path = "run_on_video/vmr_detr_ckpt/model_best.ckpt"

    # run predictions
    print("Build models...")
    clip_model_name_or_path = "ViT-B/32"
    # clip_model_name_or_path = "tmp/ViT-B-32.pt"
    vmr_detr_predictor = VMRDETRPredictor(
        ckpt_path=ckpt_path,
        clip_model_name_or_path=clip_model_name_or_path,
        device="cuda"
    )
    print("Run prediction...")
    predictions = vmr_detr_predictor.localize_moment(
